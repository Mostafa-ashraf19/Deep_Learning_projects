...
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument('--input_dim',type=int,default=2,metavar='IN',help="number of input features")
    parser.add_argument('--hidden_dim',type=int,default=10,metavar='H',help="number of hidden features")
    parser.add_argument('--output_dim',type=int,default=1,metavar='OUT',help="number of output features") 
    ...
    model = SimpleNet(args.input_dim,args.hidden_dim,args.output_dim).to(device) # device is GPU if avaliable or CPU
